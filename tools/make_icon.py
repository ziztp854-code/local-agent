...
التصميم يطابق هوية «الوكيل المحلي» بأسلوب OpenCode: مربّع بزوايا دائرية
بلون الحبر المحايد، ومعيّن ◆ برتقالي متدرّج، ولبّ كريمي. يُرسَم بتنعيم حواف
...
# هوية «طرفية OpenCode»: مربّع أسود محايد، معيّن برتقالي مشبع بتدرّج، ولمعة كريمية.
INK = (0x0A, 0x0A, 0x0A)     # قاعدة سوداء محايدة (نفس fog في الثيم الداكن)
CLAY = (0xFF, 0xA3, 0x5C)    # برتقالي فاتح (أعلى المعيّن، نفس focus)
COPPER = (0xE8, 0x6F, 0x2A)  # برتقالي أعمق (أسفل المعيّن، قريب من teal)
CREAM = (0xFF, 0xF3, 0xE6)   # كريمي دافئ للّب
